...
- ollama (opcional)
  Base de datos no relacional MongoBD

## Metodologias
- TDD
- Proyecto dirigido en Giyhub
- Los seis primeros principios de 12 facror APP
...
## Capas de la arquitectura de un software
...
típicamente en un sistema de base de datos (relacional o NoSQL).
